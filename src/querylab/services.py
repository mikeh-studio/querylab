...
from querylab.engines.factory import create_engine
from querylab.generation import ExerciseGenerationError, ExerciseGenerator
from querylab.grading.compare import compare_results
from querylab.llm import create_provider
...
def generate_advanced_progressively(
    ...
    *,
    ...
    with ThreadPoolExecutor(
        max_workers=2, thread_name_prefix="querylab-question"
    ) as pool:
        futures = {
            pool.submit(
