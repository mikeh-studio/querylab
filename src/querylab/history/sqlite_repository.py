        ...
        with self._connection() as connection:
            ...
            for column in (
                ...
                if column not in generation_columns:
                    connection.execute(
                        f"ALTER TABLE generation_runs ADD COLUMN {column} TEXT"
                    )
        ...
        with self._connection() as connection:
            connection.execute(
                ...
                INSERT INTO generation_runs(
                    ...
                    role_track, provider, requested_model,
                    requested_reasoning_effort, configuration_source, cache_key
                ) VALUES (?, ?, 'running', ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                """,
                (
                    generation_id,
                    ...
                    fields.get("requested_reasoning_effort"),
                    fields.get("configuration_source"),
        ...
        with self._connection() as connection:
            connection.execute(
                ...
                SET completed_at = ?, status = ?, cli = ?, cli_version = ?, model = ?,
                    reasoning_effort = ?, configuration_source = ?,
                ...
                (
                    ...
                    fields.get("resolved_model", fields.get("model")),
                    fields.get(
                        "resolved_reasoning_effort", fields.get("reasoning_effort")
                    ),
                    fields.get("configuration_source"),
