...
from querylab.engines.factory import SUPPORTED_DIALECTS, execution_mode
...
from querylab.feedback import (
    QueryDoctorError,
    QueryDoctorFeedback,
    review_query,
)
from querylab.generation import ExerciseGenerationError
from querylab.grading.grader import GradeResult, ReferenceSolutionError
from querylab.history import (
...
from querylab.llm.codex_cli import resolve_codex_configuration
from querylab.models import (
    Dialect,
    Difficulty,
    Exercise,
    ExerciseQuestion,
...
from querylab.services import (
    generate_advanced_progressively,
    generate_exercise_set,
    generate_exercise_set_with_telemetry,
)
from querylab.llm.base import LLMGeneration
from querylab.web.generation_jobs import GenerationJob, GenerationJobStore
from querylab.web.sessions import (
    LabSession,
...
GENERATION_LOGGER = logging.getLogger("uvicorn.error.querylab.generation")
...
def create_app(
    ...
    generation_executor = ThreadPoolExecutor(
        max_workers=3, thread_name_prefix="querylab-generation"
    )
