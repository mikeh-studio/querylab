...
from sql_lab.llm.codex_cli import resolve_codex_configuration
...
from sql_lab.web.sessions import (
    LabSession,
...
def create_app(
    ...
    generation_executor = ThreadPoolExecutor(
        max_workers=3, thread_name_prefix="sql-interview-lab-generation"
    )
